...
import 'package:firebase_messaging/firebase_messaging.dart'; // Add this import for FCM
...
class AuthProvider with ChangeNotifier {
  ...
  String? get fcmToken => _fcmToken;  // FCM Token Getter 추가
  ...
  Future<void> login(String id, String password, BuildContext context) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Get FCM Token
        if (_fcmToken != null) {
          print("FCM Toke1n: $_fcmToken");
          // Save or send FCM token to your backend if necessary
        }
  ...
  Future<void> logout() async {
    ...
    _fcmToken = null;  // Clear FCM token
